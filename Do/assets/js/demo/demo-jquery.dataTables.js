...
// ------------------------------------------------------------------------------------------------ * -->
                ...
                //* inject  to datatable DTB html中没有 查看源代码也无
                $('#exampleDTBl_wrapper .table-global-filter input')
                        .attr("placeholder", "enter search terms");
                $('#exampleDTBl_wrapper .table-tool-wrapper')
                        .html($('.DTB_toolBar')
                        .html());
                $('#exampleDTBl_wrapper .table-reset-wrapper')
                        .html($('.DTB_resetTable')
                        .html());
				$('#exampleDTBl_length select').select2({
						minimumResultsForSearch: 6,
						width: "off"
				});
